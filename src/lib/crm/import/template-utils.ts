...
/** Shown on prospect import upload; matches server lead-type validation rules. */
export const CRM_IMPORT_PROSPECT_LEAD_TYPE_HINT =
  'Set Lead Type to Individual or Company. Company Details columns are required only when Lead Type is Company; leave them blank for Individual rows.';
