...
export const emailSettingsNavItems: EmailSettingsNavItem[] = [
  ...
  },
  {
    ...
    href: '/email/settings/campaign-id-format',
    description:
      'One-time template for auto-generated campaign IDs (for example DD98392NHNA0).',
    icon: FingerprintOutlinedIcon,
    requiredPermission: 'email-config:read',
  },
];
...
export function getEmailConfigCategoryFromPathname(
  ...
  if (relativePath.startsWith('/email/settings/campaign-id-format')) {
    return null;
  }
