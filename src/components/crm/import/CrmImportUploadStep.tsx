...
import {
  CRM_IMPORT_PROSPECT_LEAD_TYPE_HINT,
  downloadCrmImportTemplate,
} from '@/lib/crm/import/template-utils';
    ...
    <Stack spacing={3}>
      <Box>
        ...
        <Typography variant="body2" color="text.secondary" className="mt-1">
          Upload a CSV or Excel file with columns matching your {entityLabel}{' '}
          field definitions from Manage Forms.
        </Typography>
        {entityType === 'prospect' ? (
