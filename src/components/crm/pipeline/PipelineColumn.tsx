...
import { isOrgOwnedPipelineStageOption } from '@/lib/crm/pipeline/stage-option-rules';
import type {
  Prospect,
...
interface PipelineColumnProps {
  ...
  onEditStage: (stageValue: string, stageLabel: string, color: string) => void;
      ...
      >
        ...
        >
          ...
          <ManageStageMenu
            ...
            isOrgOwnedStage={isOrgOwnedPipelineStageOption(stage)}
            canManage={canManageStages}
            onEditColor={() =>
              onEditStageColor(stage.value, stage.label, stageColor)
            }
            onEditStage={() =>
              onEditStage(stage.value, stage.label, stageColor)
            }
