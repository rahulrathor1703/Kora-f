    ...
    >
      <Stack direction="row" spacing={1} sx={{ alignItems: 'center' }}>
        ...
        <IconButton
          ...
          disabled={!isProspectFieldDeletable(field, fieldKeysInUse, fields)}
...
export default function ProspectFieldSortableList({
  fields,
  fieldKeysInUse,
  selectedIndex,
  onSelect,
  onReorder,
  onRemove,
}: ProspectFieldSortableListProps) {
