...
export default function PauseCampaignDialog({
  open,
  campaignName,
  isSubmitting = false,
  onClose,
  ...
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="xs" fullWidth>
      <DialogTitle className="font-bold">Pause campaign</DialogTitle>
      <DialogContent>
        <Stack spacing={2}>
          <Typography variant="body2" color="text.secondary">
            ...
            . Sending will pause until this date, or you can resume manually at any
            time.
          </Typography>
